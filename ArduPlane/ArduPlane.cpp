...
void Plane::handle_auto_mode(void)
{
    ...
    case MAV_CMD_NAV_LAND:
        ...
        if (auto_state.land_complete || (auto_state.wp_proportion > 0.5)) {
            ...
            if (!airspeed.use()) {
                ...
                nav_pitch_cd = constrain_int32(nav_pitch_cd, g.approach_pitch_cd, nav_pitch_cd);
            }
        }
        calc_throttle();
...
#define RAPID_CLIMBOUT_OUT_ALT    50
       ...
       (auto_state.takeoff_complete == true))
    {
        ...
        gcs_send_text_fmt(PSTR("Below %dm; commencing Rapid Climbout.\n"),RAPID_CLIMBOUT_IN_ALT);
    ...
    {
        gcs_send_text_fmt(PSTR("Rapid Climbout finished; resuming RTL.\n"));
        steer_state.hold_course_cd = -1;
        auto_state.takeoff_complete = true;
